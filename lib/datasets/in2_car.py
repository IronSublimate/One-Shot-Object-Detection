...
class IN2Car(imdb):
    def __init__(self, image_set: str):
        imdb.__init__(self, 'in2_car_' + image_set)
        ...
        self._data_path = osp.join(cfg.DATA_DIR, 'in2_car')
        ...
        #                                     "coco_{}_e2e_mask_rcnn_R_101_FPN_1x_caffe2.pkl".format(self._data_name))
        #
        # assert os.path.exists(self._reference_file), \
        #     f'No such reference file: {self._reference_file}.'
    ...
    def _get_ann_file(self):
        ...
        return osp.join(self._data_path, 'coco_lables', self._image_set + '.json')
    ...
    def image_path_from_index(self, index):
        ...
        image_path = osp.join(self._data_path, 'JPEGImages',
                              file_name)
